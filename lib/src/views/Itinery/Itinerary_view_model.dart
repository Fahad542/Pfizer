...
class ItinerayViewModel extends ReactiveViewModel
    with ApiViewModel, AuthViewModel {
  BuildContext context;
  ItinerayViewModel(this.context);

  TextEditingController date = TextEditingController();
  DateTime selectedDateTime = DateTime.now();
  DateTime max = DateTime.now();

  List<My_Itineraray> Data = [];
  ...
  Future<void> ExpenseList(BuildContext context) async {
    ...
    var newsResponse =
    await runBusyFuture(apiService.myitinerarayList(context));
